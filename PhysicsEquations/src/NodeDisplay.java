	...
	public void mouseClicked(MouseEvent e) {
		...
		case EVALUATE:
			...
			if (n != null && n instanceof VariableNode) {
				Double result = Main.find(((VariableNode)n).getSymbol());
				if (result == null)
					JOptionPane.showMessageDialog(null, "Could not solve equation.",
							"No Solution", JOptionPane.ERROR_MESSAGE);
				else
					JOptionPane.showMessageDialog(null, "Solution: " + result,
